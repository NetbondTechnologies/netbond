      ...
      <div className="contact">
        ...
        <div className="contact-s2 py-20">
          ...
          <div className="form-area flex justify-center mb-40 w-[90%] mx-auto ">
            <div className="form-info flex flex-col gap-10 w-[40%]">
              ...
              <p>
                <ul className="list-disc ml-10 text-lg">
                  <li className="pb-4">You’ll receive a prompt response from our team.</li>
                  <li className="pb-4">We’ll carefully assess your requirements.</li>
            ...
            <div className="form-component bg-white rounded-3xl py-6 px-6 w-[55%]">
              <form
                action=""
                onSubmit={(e) => {
                  e.preventDefault();
              ...
              >
                ...
                <input 
                  ...
                  name="name"
                  id="name"
                  className="block w-full bg-black/5 rounded-md px-3 py-1 text-md mb-5 mt-2 focus:ring-3 outline-none focus:ring-(--pumpkin) focus:ring-offset-3 focus:ring-offset-white duration-200"
                />
                ...
                <textarea
                  name="message"
                  id="message"
                  className="resize-none block w-full bg-black/5 rounded-md px-3 py-1 text-md mb-5 mt-2 focus:ring-3 outline-none focus:ring-(--pumpkin) focus:ring-offset-3 focus:ring-offset-white duration-200"
                  rows={6}
                ></textarea>
                <button
                  type="submit"
                ...
                <div className="contact-location flex justify-center w-[90%] mx-auto">
                  <div className="location-details w-[49%]">
                    ...
                    <p className=" contact-head text-lg">NETBOND TECHNOLOGIES PVT. LTD.</p>
                    <span className="block pb-5">SCO – 41, 2nd floor, oxford street, Near Royal Estate, Zirakpur, Punjab – 140603</span>
                    ...
                    <span className="block pb-5">support@netbondtechnologies.com</span>
                    <hr className="w-[90%] border-1 " />
                  ...
                  <div className="map w-[50%]"><div style={{width: "100%"}}><iframe width="100%" height="500" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=NetBond%20Technologies%20%7C%20Branding%20&amp;%20Digital%20Marketing%20Company%20in%20Zirakpur,%202nd%20floor,%20Sco-41,%20Ambala%20Road,%20near%20royal%20estate,%20Zirakpur,%20Punjab%20140603+(Netbond%20Technologies)&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.mapsdirections.info/calcular-la-población-en-un-mapa">Calcular Población en el Mapa</a></iframe></div></div>
